...
export const metadata=buildPageMetadata({title:"测试 Skill 设计与资产封装教程",description:"把检查清单、SQL、评分规则和团队经验封装成可复用 Skill，覆盖目录结构、Schema、版本回归、执行边界，以及何时需要接入 MCP 工具。",path:"/knowledge/testing-skills-design",tags:["测试Skill","MCP","测试资产","AI辅助测试","质量工程"]});
