...
function Next() { return <div className="mt-8 flex flex-wrap items-center justify-between gap-4 border-y border-space-border py-6"><p className="text-sm text-text-secondary">下一阶段：沿 Document、Chunk、Retrieval、Context、Generation 和 Citation 分层定位 RAG 质量问题。</p><Link href="/knowledge/rag-knowledge-base-testing" className="inline-flex items-center gap-2 text-sm text-neon-cyan">RAG 知识库测试<ArrowRight className="h-4 w-4" /></Link></div>; }
