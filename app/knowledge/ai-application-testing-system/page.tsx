...
function Header() { return <header className="mb-10"><div className="mb-3 font-mono text-[10px] uppercase tracking-[0.22em] text-neon-cyan">AI System Quality / Evaluation 02</div><h1 className="mb-3 bg-gradient-to-r from-neon-cyan to-neon-purple bg-clip-text text-3xl font-bold text-transparent md:text-4xl">AI 应用评估体系教程</h1><p className="mb-6 text-lg leading-8 text-text-secondary">把评估目标、分层样本、人工金标、机器检查和版本回归连起来，让“回答不错”变成能够解释、复现和发布的质量证据。</p><div className="flex flex-wrap gap-6 text-sm text-text-secondary"><span>8 个章节</span><span>评估集 + 人工金标</span><span>机器 Check + 版本回归</span></div></header>; }
...
function Next() { return <div className="mt-8 flex flex-wrap items-center justify-between gap-4 border-y border-space-border py-6"><p className="text-sm text-text-secondary">下一步：把同样的金标、指标与人工复核应用到图片、表格和文档抽取链路。</p><Link href="/knowledge/multimodal-ocr-testing" className="inline-flex items-center gap-2 text-sm text-neon-cyan">多模态、OCR 与文档智能测试<ArrowRight className="h-4 w-4" /></Link></div>; }
