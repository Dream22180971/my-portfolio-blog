...
function Next() { return <div className="mt-8 flex flex-wrap items-center justify-between gap-4 border-y border-space-border py-6"><p className="text-sm text-text-secondary">性能、成本、安全与人工边界已经闭环，回到总路线继续查漏补缺。</p><Link href="/knowledge/tutorials?track=ai-testing" className="inline-flex items-center gap-2 text-sm text-neon-cyan">完成 AI 测试路线<ArrowRight className="h-4 w-4" /></Link></div>; }
