  ...
  return (
    <div ref={ref} className="relative inline-flex">
      <button
        ...
        className="share-button focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-neon-cyan"
        aria-expanded={open}
      ...
      {open && (
        <div id={menuId} role="menu" className="share-menu absolute right-0 top-full z-50 mt-3 w-48 animate-fade-in">
          <button
            onClick={copyLink}
            role="menuitem"
          >
