...
- AI 测试强化支线形成 11 篇连续教程，覆盖 AI 质量基础、应用专项质量、智能体、可靠性与安全、AI 原生测试工程五个阶段。
- 发布大模型基础、评估体系、RAG、OCR、Agent、MCP、安全红队、性能成本、上下文工程、测试 Skill 和人机协作工作流教程。
- 补充权限与数据隔离、测试数据治理、测试资产追溯和测试平台开发，完善测试开发进阶路线。
- 将系统教程扩展到 38 篇，并保留 4 篇后续规划；同步修复章节定位、亮暗主题和教程路线衔接。
...
| `/knowledge` | 六阶段测试工程师成长路线、38 篇系统教程、测试开发与 AI 测试强化支线、实战手册和工具速查 |
